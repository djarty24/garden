    ...
    return (
        <section id="work" ref={containerRef} className="bg-canvas relative h-[800vh]">
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                <motion.div style={{ opacity: titleOpacity }} className="absolute top-4 md:top-16 lg:top-24 w-full z-10 pointer-events-none text-center">
                    <h2 className="text-2xl md:text-3xl font-serif text-ink">Selected Works</h2>
                </motion.div>

                <div className="relative w-full max-w-6xl mx-auto px-4 md:px-8 h-[85vh] md:h-[70vh] mt-12 md:mt-20">

                    <motion.div style={p1} className="absolute top-1/2 -translate-y-1/2 left-0 w-full flex flex-col md:flex-row items-center gap-3 md:gap-12 lg:gap-24 mt-6 md:mt-0">
                        <div className="w-full md:w-1/2 flex justify-center z-10">
                            <a href="https://pocketpix.vercel.app/" target="_blank" className="w-[60%] md:w-[90%] lg:w-full max-w-lg aspect-4/3 relative group block mt-2 md:mt-8 lg:mt-12 mx-auto">
                                <div className="absolute bottom-full left-0 w-full h-8 md:h-16 lg:h-28 pointer-events-none -mb-0.5 z-0">
                                ...
                                <div className="relative w-full h-full z-20 transition-transform duration-500 ease-out origin-top group-hover:-rotate-2 border-[6px] md:border-12 lg:border-20 border-white bg-white shadow-2xl">
                                    <img src="/work/pocketpix.png" alt="PocketPix" className="w-full h-full object-cover" />
                                </div>
                            </a>
                        </div>
                        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-2 md:gap-4 lg:gap-6 text-center md:text-left z-20 px-4 md:px-0 mx-auto md:mx-0">
                            <h3 className="text-2xl md:text-4xl lg:text-5xl font-serif text-ink italic">PocketPix</h3>
                            <div className="flex flex-wrap gap-2 md:gap-3 lg:gap-4 justify-center md:justify-start w-full pt-1 pb-1 md:pt-2 md:pb-2">
                                {["React", "TypeScript", "Vite"].map((tech, index) => {
                                    const styleObj = tapeStyles[index % tapeStyles.length];
                                    return (
                                        <span key={tech} style={{ backgroundColor: styleObj.bg }} className={`inline-block px-3 py-1 md:px-4 md:py-1.5 text-slate font-mono text-[9px] md:text-[10px] tracking-widest shadow-sm border-l-2 border-r-2 border-white/40 ${styleObj.rot}`}>
                                            {tech}
                                        </span>
                                    );
                                })}
                            </div>
                            <p className="font-sans text-slate leading-relaxed text-xs md:text-sm lg:text-lg max-w-lg text-center md:text-left mx-auto md:mx-0">
                            ...
                            <a href="https://pocketpix.vercel.app/" target="_blank" className="squiggly-underline w-fit inline-flex items-center gap-2 md:gap-4 text-xs md:text-sm lg:text-md font-serif italic text-ink hover:text-slate transition-colors mt-1 md:mt-2 mx-auto md:mx-0">
                                View Project
                            </a>
                        </div>
                    </motion.div>

                    <motion.div style={p2} className="absolute top-1/2 -translate-y-1/2 left-0 w-full flex flex-col md:flex-row-reverse items-center gap-3 md:gap-12 lg:gap-24 mt-6 md:mt-0">
                        <div className="w-full md:w-1/2 flex justify-center z-10">
                            <a href="https://ditch-explorer.vercel.app/" target="_blank" className="w-[60%] md:w-[90%] lg:w-full max-w-lg aspect-4/3 relative group block mt-2 md:mt-8 lg:mt-12 mx-auto">
                                <div className="absolute bottom-full left-0 w-full h-8 md:h-16 lg:h-28 pointer-events-none -mb-0.5 z-0">
                                    <svg className="w-full h-full overflow-visible">
                                        <line x1="50%" y1="12" x2="15%" y2="100%" stroke="currentColor" strokeWidth="1.5" className="text-slate/30" />
                                        <line x1="50%" y1="12" x2="85%" y2="100%" stroke="currentColor" strokeWidth="1.5" className="text-slate/30" />
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-2 md:gap-4 lg:gap-6 text-center md:text-left z-20 px-4 md:px-0 mx-auto md:mx-0">
                            <h3 className="text-2xl md:text-4xl lg:text-5xl font-serif text-ink italic">Ditch Explorer</h3>
                            <div className="flex flex-wrap gap-2 md:gap-3 lg:gap-4 justify-center md:justify-start w-full pt-1 pb-1 md:pt-2 md:pb-2">
                                {["React", "Typescript", "98.css"].map((tech, index) => {
                                    const styleObj = tapeStyles[index % tapeStyles.length];
                                    return (
                                        <span key={tech} style={{ backgroundColor: styleObj.bg }} className={`inline-block px-3 py-1 md:px-4 md:py-1.5 text-slate font-sans text-[9px] md:text-[10px] tracking-widest shadow-sm border-l-2 border-r-2 border-white/40 ${styleObj.rot}`}>
                                            {tech}
                                        </span>
                                    );
                                })}
                            ...
                            <a href="https://ditch-explorer.vercel.app/" target="_blank" className="squiggly-underline w-fit inline-flex items-center gap-2 md:gap-4 text-xs md:text-sm lg:text-md font-serif italic text-ink hover:text-slate transition-colors mt-1 md:mt-2 mx-auto md:mx-0">
                                View Project
                            </a>
                        </div>
                    </motion.div>

                    <motion.div style={p3} className="absolute top-1/2 -translate-y-1/2 left-0 w-full flex flex-col md:flex-row items-center gap-3 md:gap-12 lg:gap-24 mt-6 md:mt-0">
                        <div className="w-full md:w-1/2 flex justify-center z-10">
                            <a href="https://new-leaf-seven.vercel.app/" target="_blank" className="w-[60%] md:w-[90%] lg:w-full max-w-lg aspect-4/3 relative group block mt-2 md:mt-8 lg:mt-12 mx-auto">
                                <div className="absolute bottom-full left-0 w-full h-8 md:h-16 lg:h-28 pointer-events-none -mb-0.5 z-0">
                                    <svg className="w-full h-full overflow-visible">
                                        <line x1="50%" y1="12" x2="15%" y2="100%" stroke="currentColor" strokeWidth="1.5" className="text-slate/30" />
                                        <line x1="50%" y1="12" x2="85%" y2="100%" stroke="currentColor" strokeWidth="1.5" className="text-slate/30" />
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-2 md:gap-4 lg:gap-6 text-center md:text-left z-20 px-4 md:px-0 mx-auto md:mx-0">
                            <h3 className="text-2xl md:text-4xl lg:text-5xl font-serif text-ink italic">New Leaf</h3>
                            <div className="flex flex-wrap gap-2 md:gap-3 lg:gap-4 justify-center md:justify-start w-full pt-1 pb-1 md:pt-2 md:pb-2">
                            ...
                            <a href="https://new-leaf-seven.vercel.app/" target='_blank' className="squiggly-underline w-fit inline-flex items-center gap-2 md:gap-4 text-xs md:text-sm lg:text-md font-serif italic text-ink hover:text-slate transition-colors mt-1 md:mt-2 mx-auto md:mx-0">
                                View Project
                            </a>
                        </div>
                    </motion.div>
